  ...
  return (
    <div className={className}>
      <div className='flex flex-col text-[#eaeaea]'>
        ...
        <Input placeholder={placeholder} setPlaceholder={setPlaceholder} setUserName={setUserName} fetchRepository={fetchRepository} showWarning={showWarning} setShowWarning={setShowWarning} setFoundUserName={setFoundUserName}/>
        <Warning showWarning={showWarning} userName={userName} foundUserName={foundUserName} noRepos={noRepos}/>
        <SubmitButton className='flex justify-center px-5 pb-5' setOpenModal={setOpenModal} setUserName={setUserName} userName={userName} setData={setData} setShowWarning={setShowWarning} setFoundUserName={setFoundUserName} fetchRepository={fetchRepository}/>
